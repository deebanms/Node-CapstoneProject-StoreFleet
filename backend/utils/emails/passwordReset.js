    ...
    html: `
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    <p>Hello, ${user.name}</p>
                    <p>Enter this token to complete the reset: <strong> ${resetPasswordURL} </strong></p>
                    <p>Use this token as a parameter in reset password route.If you didn't request this password reset, kindly ignore this mail.</p>               
                </div>
            </div>
        </body>
        </html>
